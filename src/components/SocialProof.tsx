...
export default function SocialProof() {
  return (
    <section id="testimonials" className="py-16 sm:py-20 border-b border-zinc-200/80 bg-[#fafafa] relative overflow-hidden max-w-full">
      <div className="w-full border-y border-zinc-200 bg-white py-6 sm:py-8 mb-16 sm:mb-20 overflow-hidden select-none shadow-xs max-w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 mb-4 text-left">
        ...
        <div className="relative flex w-full overflow-hidden max-w-full">
