    ...
    <section className="relative w-full pt-28 pb-16 md:pt-36 md:pb-24 px-6 grid-bg border-b border-zinc-200/80 overflow-hidden bg-[#fafafa]">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white border border-zinc-200/80 text-xs font-mono font-medium text-zinc-700 mb-6 shadow-xs max-w-full flex-wrap">
            <span className="flex size-2 rounded-full bg-brand-emerald animate-pulse shrink-0"></span>
            <span>RUPA EMPLOYMENT AGENCY · SERVING NYC FOR 15+ YEARS (EST. 2005)</span>
          </div>
